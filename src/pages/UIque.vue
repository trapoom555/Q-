...
<div id="body-all">
  <div class="bg-head">
    ...
    <div class="box-circle">
      ...
      <div class="box-item" style="font-size:28px; display:inline-block;" >{{user.process_list[user.process_list.length-1].status-user.queueRef.q_call + " "}}</div>
    ...
    <div class="box-circle" style="border-bottom:0;padding-top:10%;">
      ...
      <div class="box-item" style="display:inline-block; font-size: 3.5vw;"> hr</div>
    </div>
    </div>
  </div>
  ...
  <div v-for = "e in this.user.process_list" :key="e.name" style="padding-left:20px; font-size: 4.2vw;">
    <div :class = "{grey: e.isFinished}" style = "text-align:justify; width: 60%; margin:auto;"><br><span>{{e.name}}</span><span style = "float:right">{{e.status}}</span><br></div>
  </div>
